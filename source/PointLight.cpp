...
{
	Reset();
	pCamera = std::make_shared<Camera>(gfx, "Light", cbData.pos, 0.f, 0.f, true);
}
...
void PointLight::SpawnControlWindow() noexcept
{
	if (ImGui::Begin("Light"))
	{
		...
		ImGui::Text("Falloff");
		ImGui::SliderFloat("Constant", &cbData.attConst, 0.05f, 10.f, "%.2f", 4);
		ImGui::SliderFloat("Linear", &cbData.attLin, 0.0001f, 4.f, "%.4f", 8);
		ImGui::SliderFloat("Quadratic", &cbData.attQuad, 0.0000001f, 10.f, "%.7f", 10);

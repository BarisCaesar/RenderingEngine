...
std::optional<int> Window::ProcessMessages() noexcept
{
	...
	{
		// check for quit because peekmessage does not signal quit via return value;
...
LRESULT Window::HandleMsg(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam) noexcept
{
	...
	case WM_MOUSEMOVE:
	{
		// if cursor is not enabled make sure the mouse is captured even when it is outside the window
		if (!cursorEnabled)
		{
			if (!mouse.IsInWindow())
			{
...
{
	return "R Window Exception [No Graphics]";
}
...
namespace REngineExp
{
	...
	public:
		...
		{
			using SysType = REngineExp::BGRAColor;
	...
	{
	public:
		VertexBuffer(VertexLayout layout_in) noexcept(!IS_DEBUG)
			:
		...
		Vertex operator[](size_t i) const noexcept(!IS_DEBUG)
		{
